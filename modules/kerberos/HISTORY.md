...
<a name="1.1.3"></a>
## [1.1.3](https://github.com/mongodb-js/kerberos/compare/v1.2.0...v1.1.3) (2019-08-05)


### Bug Fixes

* add support for node 12 ([dcbfb88](https://github.com/mongodb-js/kerberos/commit/dcbfb88))
